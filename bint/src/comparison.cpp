...
bool chunk_is_equal(const bintfield& left_field,const bintfield& right_field){
...
bool chunk_is_not_equal(const bintfield& left_field,const bintfield& right_field){
    return !(chunk_is_equal(left_field,right_field));
}

/// compares absolute values of chunks
bool chunk_is_less(const bintfield& left_field,const bintfield& right_field){
...
bool chunk_is_great(const bintfield& left_field,const bintfield& right_field){
    if(chunk_is_equal(left_field,right_field))
        return false;
    return !(chunk_is_less(left_field,right_field));
}

bool chunk_is_less_equal(const bintfield& left_field,const bintfield& right_field){
    if(chunk_is_equal(left_field,right_field))
        return true;
    return chunk_is_less(left_field,right_field);
}

bool chunk_is_great_equal(const bintfield& left_field,const bintfield& right_field){
    if(chunk_is_equal(left_field,right_field))
        return true;
    return chunk_is_great(left_field,right_field);
}

bool bint::operator==(const bint& that) const // base comparison operator - use to create other comparison operators
{
    if(this->sign!=that.get_sign()) return false;
...
bool bint::operator< (const bint& that) const
{
