...
int main()
{
    ...
    cout<<line<<endl;
    cout<<"\nbint sample program 2 - performance test"<<endl;
    cout<<line<<endl;
    auto start1 = high_resolution_clock::now();
    // initialize
    bint var1 = (string(50,'5')+string(50,'2')+string(50,'1')+string(50,'9')); // a 200 digit length number
    ...
    // initialize
    bint var2 = "-"+(string(50,'9')+string(50,'8')+string(50,'2')+string(50,'7')); // a negative 200 digit length number
