...
int main() { START_TEST;
    ...
    #if defined(_BASE2_16)
    {
        ...
        apa::integer num2 = { 0x794c, 0x412a, 0xcd27, 0xa845, 0x782f, 0x308f, 0x6e20, 0xaafc, 0x5b0a, 0x5a45, 0xe69c, 0x8045 };

        fib1000_1_99927737 = num1 + num2;
        fib1000_b9_9 = num2 + num1;

        apa::integer ans1 = num1 + num2;
        apa::integer ans2 = num2 + num1;
