...
int main() {
    ...
    apa::integer ANSQ1 = NUM1.bit_division(NUM2), ANSQ2 = NUM1.bit_division(NUM3), ANSQ3 = NUM2.bit_division(NUM3),
                 ANSR1 = NUM1.bit_modulo(NUM2), ANSR2 = NUM1.bit_modulo(NUM3), ANSR3 = NUM2.bit_modulo(NUM3);
    ...
    ASSERT_EQUALITY(NUM1.bit_modulo(NUM1), ZERO, "16 NUM1.bit_modulo(NUM1) ");
    ASSERT_EQUALITY(NUM2.bit_modulo(NUM2), ZERO, "17 NUM2.bit_modulo(NUM2) ");
    ASSERT_EQUALITY(NUM3.bit_modulo(NUM3), ZERO, "18 NUM3.bit_modulo(NUM13)");
