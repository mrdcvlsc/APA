...
int main() { START_TEST;
    ...
    apa::ubint base8(
        ...
        "77777777750112512434457126534700000000000000000000",8
    );
    ...
    apa::ubint base10_default ("1792719198763919877864491671917284253530489706249053429919273492850310328205362535189184512");
    ...
    ASSERT_EQUALITY(base16,base10,        "base16==base10        ");
        ...
        RESULT("UBINT BASE 2^32 base2, base8, base10, base16 constructor");
    #elif defined(_BASE2_64)
        RESULT("UBINT BASE 2^64 base2, base8, base10, base16 constructor");
    #endif
}